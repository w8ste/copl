...
object State {
  ...
  case class Num(n: Int)                                                  extends StateExpr
  case class Add(lhs: StateExpr, rhs: StateExpr)                          extends StateExpr
  case class Let(name: String, namedExpr: StateExpr, body: StateExpr)     extends StateExpr
  case class Id(name: String)                                             extends StateExpr
  case class If0(test: StateExpr, posBody: StateExpr, negBody: StateExpr) extends StateExpr
  case class Fun(param: String, body: StateExpr)                          extends StateExpr
  case class App(funExpr: StateExpr, argExpr: StateExpr)                  extends StateExpr
  case class Seqn(e1: StateExpr, e2: StateExpr)                           extends StateExpr
  case class SetId(id: String, valueExpr: StateExpr)                      extends StateExpr
  case class NewBox(valExpr: StateExpr)                                   extends StateExpr
  case class SetBox(boxExpr: StateExpr, valueExpr: StateExpr)             extends StateExpr
  case class OpenBox(boxExpr: StateExpr)                                  extends StateExpr
  ...
  /** ReFun case is only used in the second interpreter.
    ...
    */
  case class ReFun(param: String, body: StateExpr) extends StateExpr
  ...
  case class Closure(param: String, body: StateExpr, env: Env)
  ...
  trait Base {
    ...
    def interp(expr: StateExpr): (Value, Store) = interp(expr, Map.empty, Map.empty)
  ...
  object CallByReference extends Base {
    ...
    case class RefClosure(param: String, body: StateExpr, env: Env)
